...
__declspec(dllexport) long CallAgent(const char *agentname, int count, const wchar_t* referrer, const wchar_t **urls, const wchar_t **cookies, const wchar_t **descs);
