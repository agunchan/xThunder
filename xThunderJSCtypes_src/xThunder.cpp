...
public:
	...
	long dispatch(DownloadInfo & downInfo)
	{
		...
		if (downInfo.count == 1) 
		{
			...
			v[1] = 0;
			v[0] = 0;	//OffLine - 10600 or 10300(lixian.qq.com), Normal - 0 
			invoke("SendUrl2", v, 6);
		} 
...
long CallAgent(const char *agentname, int count, const wchar_t* referrer, const wchar_t **urls, const wchar_t **cookies, const wchar_t **descs)
{
